...
CREATE TABLE IF NOT EXISTS `devlog`.`Project` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Project_Team1_idx` (`Team_id` ASC),
  INDEX `idx_Project_id_Team_id` (`id`, `Team_id`),
...
CREATE TABLE IF NOT EXISTS `devlog`.`User` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_User_Project1_idx` (`Project_id` ASC, `Project_Team_id` ASC),
...
CREATE TABLE IF NOT EXISTS `devlog`.`Task` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Task_Project1_idx` (`Project_id1` ASC),
